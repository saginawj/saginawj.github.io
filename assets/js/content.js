window.siteContent = (() => {
const regions = [
  { id: 'places', name: 'Travel', number: '01', description: 'Where I’ve been and where I’m going.', visibility: 'private', app: { name: 'Dunia', description: 'My travel map, trips, photographs, and stories.', icon: 'assets/img/dunia-logo.png', iconAlt: 'Dunia globe and location-pin logo', fallback: 'DU', url: 'https://travel.goodluckfinding.me' } },
  { id: 'money', name: 'Money', number: '02', description: 'How I spend, save, invest, and pay attention.', visibility: 'private', position: 'east', app: { name: 'Akiba', description: 'A private system for understanding my financial life.', icon: 'assets/img/akiba-logo.png', iconAlt: 'Akiba wallet and growth-chart logo', fallback: 'AK', url: 'https://money.goodluckfinding.me' } },
  { id: 'memory', name: 'Journal', number: '03', description: 'What I want to remember, and who was there.', visibility: 'private', app: { name: 'Yalda', description: 'My journal, life record, and relationship memory.', icon: 'assets/img/yalda-logo.png', iconAlt: 'Yalda book and moon logo', fallback: 'YA', url: 'https://journal.goodluckfinding.me' } },
  { id: 'body', name: 'Fitness', number: '04', description: 'Health, movement, sleep, and the physical record.', visibility: 'private', app: { name: 'Milo', description: 'My health, movement, sleep, and physical record.', icon: 'assets/img/milo-logo.png', iconAlt: 'Milo movement logo', fallback: 'MI', url: 'https://body.goodluckfinding.me/' } }
];
const projects = [
